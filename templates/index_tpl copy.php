        ...
        <div class="banner has-hover has-slide-effect slide-zoom-in" id="banner-911773482">
            <div class="banner-inner fill">
                ...
                <div class="banner-layers container">
                    ...
                    <div id="text-box-895046455"
                        class="text-box banner-layer x0 md-x0 lg-x0 y50 md-y50 lg-y50 res-text">
                            ...
                            <div class="text-box-content text dark">
                                <div class="text-inner text-left">
                                    ...
                                    <div class="is-divider divider clearfix"
                                        style="max-width:70px;height:5px;background-color:rgb(0, 174, 239);"></div>
                                    <div id="text-1565145803" class="text">
                                        <?=$v['mota_vi']?>

                                    </div>
                                    <div id="gap-1628918654" class="gap-element clearfix"
                                    ...
                                    <a href="<?=$v['link']?>"
                                        class="button alert is-shade box-shadow-3 box-shadow-5-hover lowercase"
            ...
            <div class="height-fix is-invisible"><img width="1600" height="592" src="<?=_upload_hinhanh_l.$v['photo']?>"
                    class="attachment-original size-original" alt="" decoding="async" /></div>
            <style>
                ...
                <div class="col-inner">
                    <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_1531560350">
                        <div class="img-inner dark">
                            <img width="448" height="632" src="<?=_upload_tinnho_l.$gioithieutc['photo']?>"
                                class="attachment-original size-original" alt="Giấy chứng nhận" decoding="async"
                                loading="lazy"
                                srcset="<?=_upload_tinnho_l.$gioithieutc['photo']?> 448w, <?=_upload_tinnho_l.$gioithieutc['photo']?> 213w"
                ...
                <div class="col-inner text-center">
                    ...
                    <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_328830819">
                        <div class="img-inner image-cover dark" style="padding-top:100%;">
                            <img width="773" height="800" src="<?=_upload_sanpham_l.$v['photo']?>"
                                class="attachment-original size-original" alt="" decoding="async" loading="lazy"
                                srcset="<?=_upload_sanpham_l.$v['photo']?> 773w, <?=_upload_sanpham_l.$v['photo']?> 290w, <?=_upload_sanpham_l.$v['photo']?> 768w"
        ...
        <div class="row align-bottom" id="row-110031677">
            <div id="col-922287566" class="col cot1 medium-5 small-12 large-5">
                <div class="col-inner">
                    ...
                    <?=$motalydo['mota_vi']?>
                    <a href="dang-ky-tai-khoan" target="_self" class="button alert is-underline lowercase"
                                    ...
                                    <div class="icon-box-img" style="width: 60px">
                                        <div class="icon">
                                            <div class="icon-inner">
                                                <img width="57" height="57" src="<?=_upload_tinnho_l.$v['photo']?>"
                            ...
                            <div class="flex-row form-flat medium-flex-wrap">
                                <div class="flex-col flex-grow">
                                    <p><span class="wpcf7-form-control-wrap" data-name="email-50"><input size="40"
                                                ...
                                                required placeholder="Nhập địa chỉ email*" value="" type="email"
                                                name="txtEmail" /></span>
                                    </p>
                                </div>
                                    ...
                                    <div class="box box-normal box-text-bottom box-blog-post has-hover">
                                        ...
                                        <div class="badge absolute top post-date badge-outline">
                                            <div class="badge-inner">
                                                ...
                                                <span
                                                    class="post-date-month is-xsmall">Th<?=date('m',$v['ngaytao'])?></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-inner">
                                <a href="<?=$v['tenkhongdau_vi']?>" class="plain">
                                    <div class="box box-normal box-text-bottom box-blog-post has-hover">
                                        ...
                                        <div class="box-text text-center">
                                            <div class="box-text-inner blog-post-inner">
                                                <h5 class="post-title is-large "><?=$v['ten_vi']?></h5>g
                                                <div class="is-divider"></div>
                                                <p class="from_the_blog_excerpt "><?=$v['mota_vi']?> </p>
                                            </div>
                                        </div>
