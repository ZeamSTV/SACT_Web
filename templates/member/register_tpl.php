    ...
    <section class="section" id="section-register">
        <div class="container">
            ...
            <div class="register-form lc-form-wrap">
                <form class="lc-form-inner" method="post" action="dang-ky.html" id="form-register"
                  ...
                  <div class="form-item">
                    ...
                    <div class="form-item-wrap account-type-item active" id="accountPersonInfo">
                        ...
                        <div class="form-item">
                            <div class="form-item-body">
                                <div class="form-group">
                                    <input type="text" placeholder="Ngày tháng năm sinh (*)" class="form-control"
                                        name="birthday">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-item">
                            <div class="form-item-body">
                                <div class="form-group">
                                    <input type="password" placeholder="Mật khẩu đăng nhập (*)" class="form-control"
                        ...
                        <div class="form-item">
                            <div class="form-item-body">
                                <div class="form-group">
                                    <input type="text" placeholder="Địa chỉ thường chú ( Nơi nhận hợp đồng ) (*)"
                                        class="form-control" name="personal_address">
                                </div>
                            </div>
                        </div>
                        <div class="form-item">
                    ...
                    <div class="form-item-wrap" id="identifyInfo">
                        ...
                        <div class="row-2">
                            <div class="form-group">
                                ...
                                <select name="identify_type" id="identify_type" class="form-control valid"
                                    data-gtm-form-interact-field-id="2" aria-invalid="false">
                            ...
                            <div class="identify-front">
                                ...
                                <img class="identify-front-preview"
                                    src="https://2.bp.blogspot.com/-muVbmju-gkA/Vir94NirTeI/AAAAAAAAT9c/VoHzHZzQmR4/s1600/placeholder-image.jpg">
                                <input type="file" name="identify_image_front" data-preview="identify_preview_front"
                                    id="identify_image_front" data-type="front" class="input_Identify">
                                <label for="identify_image_front" class="btn   btnUploadIdentify btn-sm">Upload
                                    ảnh</label>
                            </div>
                            <div class="identify-back">
                                <label for="identify_image_back">Hình chụp CMND mặt sau</label>
                                <img class="identify-back-preview"
                                    src="https://2.bp.blogspot.com/-muVbmju-gkA/Vir94NirTeI/AAAAAAAAT9c/VoHzHZzQmR4/s1600/placeholder-image.jpg">
                                <input type="file" name="identify_image_back" data-preview="identify_preview_back"
                                    id="identify_image_back" data-type="back" class="input_Identify">
                                <label for="identify_image_back" class="btn   btnUploadIdentify btn-sm">Upload
                                    ảnh</label>
