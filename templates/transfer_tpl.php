...
<style>
	body{ margin:0px; padding:0px; background:url(media/images/icon/LoadinBlue.gif) center 15px no-repeat; }
	#noidung{ font-size:14px; color:#333; padding:20px 30px 5px 30px; border:1px dashed #3AB0E4; text-align:center; min-width: 260px; max-width:400px; margin:90px auto 0px; }
