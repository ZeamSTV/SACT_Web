		...
		<section id="main_info1">
		    ...
		    <div class="main_noidung_info">
		        ...
		        <div class="sp_info" <?=$te?>>
		            <a href="san-pham/<?=($v['cat']!="")?q_bodautv($v['cat']):"-"?>/<?=($v['cat1']!="")?q_bodautv($v['cat1']):"-"?>/<?=($v['cat2']!="")?q_bodautv($v['cat2']):"-"?>/<?=($v['ten']!="")?q_bodautv($v['ten']):"-"?>-<?=$v['id']?>.html"
		                class="sp_img" title="<?=$v['ten']?>"><img src="<?=_upload_sanpham_l.$v['thumb']?>" width="210"
		                    height="170" border="0" title="<?=$v['ten']?>" alt="<?=$v['ten']?>"></a>
		            <div class="clear" style="width:100%; height:5px;"></div>
		            <h2>
		                <a href="san-pham/<?=($v['cat']!="")?q_bodautv($v['cat']):"-"?>/<?=($v['cat1']!="")?q_bodautv($v['cat1']):"-"?>/<?=($v['cat2']!="")?q_bodautv($v['cat2']):"-"?>/<?=($v['ten']!="")?q_bodautv($v['ten']):"-"?>-<?=$v['id']?>.html"
		                    class="sp_ten" title="<?=$v['ten']?>"><?=$v['ten']?></a>
		            </h2>
