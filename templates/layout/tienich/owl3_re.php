<?php 
$d->reset();
$sql = "select * from #_product where hienthi=1 and hot=1 order by id desc limit 0,80";
$d->query($sql);
$diemdenmoi_re = $d->result_array();
?>
<!-- Owl Carousel Assets -->
<!--
	...
	-->
  <div id="owl-demo3_re" class="owl-carousel">
				
					
				<?php for($i4=0;$i4<count($diemdenmoi_re);$i4++) {
					$v = $diemdenmoi_re[$i4];
					?>
