<header id="header" class="header has-sticky sticky-jump" style="background-color: #ffffff;">
    <div style="height: auto">
        ...
        <div id="masthead" class="header-main">
            <div class="header-inner container flex-row"
                style="display: flex;  align-items: center; justify-content: space-around;height: 100px; max-width: 100%;">
                <!-- Logo -->
                ...
                <nav class="nav header-nav" style="flex: 6; display: flex; justify-content: center;">
                    <ul class="header-nav-main nav"
                        style="display: flex; list-style: none; padding: 0; margin: 0;font-size: 13px;">
                        <li><a href="" class="nav-link">Trang chủ</a></li>
                        <li><a href="gioi-thieu" class="nav-link">Giới thiệu</a></li>
                        <li id="menu-i"
                            class="menu-i menu-i-type-post_type menu-i-object-page menu-i-has-children menu-i menu-i-design-default has-dropdown"
                            style="padding: 0;bottom:2px;">
                            <a href="san-pham" class="nav-link" style="padding-bottom: 6px;">Sản phẩm<i
                                    class="fa fa-chevron-down"></i></a>
                            <ul class="sub-menu nav-drop nav-drop-default">
                                <?php foreach ($cat_main as $key => $v) {?>
                                <li id="menu-i" class="menu-i menu-i-type-post_type menu-i-object-page menu-i"
                                    style="width:250px; height:50px"><a
                                        href="<?=$v['tenkhongdau_vi']?>"><?=$v['ten_vi']?></a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <li><a href="huongdan-sudung" class="nav-link">Hướng dẫn giao dịch</a></li>
                ...
                <div class="contact-info"
                    style="flex: 2; display: flex; justify-content: flex-end; gap: 30px;font-size: 14px;">
                    ...
                    <div class="info-item">
                        ...
                        <a href="tel:<?=$company['dienthoai']?>" style="color: #000;">Hotline:
                            <?=$company['dienthoai']?></a>
                    </div>
                </div>
