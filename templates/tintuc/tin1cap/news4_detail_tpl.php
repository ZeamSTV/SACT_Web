...
?>
					<div class="sanpham <?php if(($i1+1)%3==0){echo"sanpham1";} ?>">
						<div class="hinhsanpham"><a href="xay-dung-nha-dan-dung/<?=$v['tenkhongdau']?>-<?=$v['id']?>.htm"><img class="transition_09s transform_scale_12" src="<?=_upload_congtrinh_l.$v['photo']?>" alt="<?=$v['ten']?>"/></a></div>
						<div class="tensanpham"><a href="xay-dung-nha-dan-dung/<?=$v['tenkhongdau']?>-<?=$v['id']?>.htm"><?=catchuoi($v['ten'],$tu8)?></a></div>
					</div>
<?php }?>	
    </div>       	          
</section>
