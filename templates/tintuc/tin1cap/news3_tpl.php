    ...
    <div class="cascade-slider_container" id="cascade-slider">
      <div class="cascade-slider_slides">
        ...
        <div class="cascade-slider_item">
          <h3> <a href="kiem-dinh-chat-luong/<?=$v['tenkhongdau']?>-<?=$v['id']?>.htm"><?=catchuoi($v['ten'],$tu4)?></a></h3>
          <a href="kiem-dinh-chat-luong/<?=$v['tenkhongdau']?>-<?=$v['id']?>.htm" ><img src="<?=_upload_congtrinh_l.$v['thumb']?>" alt="<?=$v['ten']?>"></a>
        </div>
        <?php }?>
      </div>
