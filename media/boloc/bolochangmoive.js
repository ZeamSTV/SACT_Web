					...
					function updateQueryStringParameter(uri, key, value) {
					  ...
					  window.history.pushState('string', '', uri + hash);
	   			    ...
	   			    {			
										...
										var com1=$('#product_com').attr('data-com');
										var order=$('#product_list_order').attr('data-order');
										var page=$('#pageajax').attr('data-page');
	   			    		          $.ajax({
					                  type: "post",
					                  url: 'ajax/locsanpham.php',
					                   dataType: 'json',
					                 data: {'searchUrl1':searchUrl1,'url':url,'page':page,'order':order,'limit':limit,'price':price,'theloai':theloai,'id_quantam':id_quantam,'dactinh':dactinh,'loaida':loaida,'xuatxu':xuatxu,'donvi':donvi,'mausac':mausac,'thuonghieu':thuonghieu,'com1':com1},
