...
function listproduct_idc($pid){
	...
	function get_matin($pid){
 	...
 	function kiemtradanhsachbaiviet_cat1($id)

 	{

 		global $d, $row;

 		$sql="select * from table_tin3cap_cat where hienthi=1 and com='cat1' and id_cat=".$id." ";
 	...
 	function kiemtradanhsachbaiviet($id)

 	{

 		global $d, $row;

 		$sql="select * from table_tin3cap where hienthi=1 and tinmoi=1 and id_cat=".$id." ";
