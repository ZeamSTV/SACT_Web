...
$("#xoahet").click(function(){
	...
	if (hoi==true) document.location = "index.php?com=hethong&act=delete&listid=" + listid + "<?=$chuoi_noi_curpage?>";
});
});
</script>
<!-- Breadcrumbs Start -->
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=hethong&act=man">Trung tâm</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <!-- Inline Form Start -->      	      
        <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="inner">
            ...
            <div class="title-bar">
              <div class="col-md-8" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">                 
              	<h4><a href="index.php?com=hethong&act=add<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm </a></h4>      
              </div>
			...
			<?php
				...
				{
					$sql_huyen="select * from table_hethong_cat where com='cat2' and id_cat1='".intval($_REQUEST['id_cat1'])."' ORDER BY stt asc, id DESC";
                  ...
                  <tr>
                    ...
                    <td style=" width:20%;">
                        ...
                        <b class="cap2">Cấp 2: <?php
							$sql_danhmuc1="select ten from table_hethong_cat where id='".$v['id_cat1']."'";
							$result=mysql_query($sql_danhmuc1);
							$item_danhmuc1 =mysql_fetch_array($result);
                        ...
                        <b class="cap3">Cấp 3: <?php
							$sql_danhmuc1="select ten from table_hethong_cat where id='".$v['id_cat2']."'";
							$result=mysql_query($sql_danhmuc1);
							$item_danhmuc1 =mysql_fetch_array($result);
							echo @$item_danhmuc1['ten'];
						?>
          ...
          <!--           <td style="width:76px;"><a href="index.php?com=hethong&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=_upload_hethong.$v['photo']?>" border="1" class="" width="100px" /></a></td> 
                                      -->
                    <td><a href="index.php?com=hethong&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage?>"><?=$v['ten_vi']?></a></td> 
               <!--     <td style="width:5%;"><a href="index.php?com=hethong&act=man_photo&id_cat=<?=$v['id']?>">Thêm +</a></td>
                 -->    <!-- <td style="width:5%;"><a class="clickchange" thaydoiloai="noibat"   thaydoitable="table_hethong"  thaydoiid="<?=$v['id']?>" id="idcssnoibat<?=$v['id']?>"><img src="<?=($v['noibat']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td> -->
					<!-- <td style="width:5%;"><a class="clickchange" thaydoiloai="tinmoi"   thaydoitable="table_hethong"  thaydoiid="<?=$v['id']?>" id="idcsstinmoi<?=$v['id']?>"><img src="<?=($v['tinmoi']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td>
                    --> <td style="width:5%;"><a class="clickhienthi" thaydoiloai="hienthi"   thaydoitable="table_hethong" thaydoiid="<?=$v['id']?>" id="idcsshienthi<?=$v['id']?>"><img src="<?=($v['hienthi']==1)?'media/images/active_1.png':'media/images/active_0.png'?>" border="0" /></a></td>
                    <td style="width:5%;"><a href="index.php?com=hethong&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="media/images/edit.png" border="0" title="Sửa" /></a></td>
                   <td style="width:5%;"><a href="index.php?com=hethong&act=delete&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>                                        
                  </tr>
                  <?php	
						}
					}
			...
			<div class="col-md-12 margin_bottom_10px">
                <div class="col-md-6 paging_right_10px">                  
                 <a href="index.php?com=hethong&act=add<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm</a>
                  <a href="index.php?com=hethong&act=man" class="btn btn-info"><i class="fa fa-share"></i> Thoát</a> 
