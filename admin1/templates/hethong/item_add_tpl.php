            ...
            <div class="inner">
             ...
             <!--  	<?php if ($_REQUEST['act']=='edit'){?>
                ...
                <div class="col-md-10">
                    ...
                    <span class="description">Type: .jpg|.gif|.png|.jpeg &nbsp;&nbsp;;&nbsp;&nbsp; Ảnh chuẩn: Width:1366px - Height:397px</span>
                    <br /><br />
                </div>
        -->
          ...
          <!--       
                ...
                <div class="col-md-10"><input type="text" name="diachi" id="title" value="<?=$item['diachi']?>" placeholder="Địa chỉ" /></div>
                   <div class="col-md-2"><label>Điện thoại</label></div>
                <div class="col-md-10"><input type="text" name="dienthoai" id="title" value="<?=$item['dienthoai']?>" placeholder="Điện thoại" /></div>
                <div class="col-md-2"><label>Link</label></div>
                <div class="col-md-10"><input type="text" name="title" id="title" value="<?=$item['title']?>" placeholder="Ví dụ: 24h.com.vn" /></div>
				<!--
