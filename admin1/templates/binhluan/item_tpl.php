...
<?php
  ...
  function get_tenspbinhluan($id)
  {
    ...
    function get_hinhspbinhluan($id)
    {
      global $d;
  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=binhluan&act=man" title="Email đăng ký">Bình luận</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
      ...
      <!-- Inline Form Start -->      	      
        <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
         ...
         <!--      <div class="col-md-4 paging_0px">  
              	<form action="index.php?com=binhluan&act=man<?=$chuoi_noi_curpage?>" method="post" class="inline-form">
            ...
            <form name="frm" method="post" action="index.php?com=binhluan&act=send" enctype="multipart/form-data">		    
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">            
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img width="50" src="<?=_upload_sanpham.get_hinhspbinhluan($v['id_sp'])?>"></td>                
                    <td><b><?=get_tenspbinhluan($v['id_sp'])?></b></td>
                     <td><b><?=get_tennguoibinhluan($v['id_user'])?></b></td>
                      <td><b><?=$v['title']?></b></td>
                       <td><b><?=date('H:i | d/m/Y',$v['ngaytao'])?></b></td>
                        <td style="width:5%;"><a class="clickhienthi" thaydoiloai="hienthi"   thaydoitable="table_comment" thaydoiid="<?=$v['id']?>" id="idcsshienthi<?=$v['id']?>"><img src="<?=($v['hienthi']==1)?'media/images/active_1.png':'media/images/active_0.png'?>" border="0" /></a></td>
                    <td style="width:5%;"><a href="index.php?com=binhluan&act=delete&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>
                      <td style="width:5%;"><a href="index.php?com=binhluan&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" ><img src="media/images/edit.png" border="0" title="Xem" /></a></td>
                  </tr>
                  <?php	
						}
					}
