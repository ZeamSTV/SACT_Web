        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          ...
          <div class="col-sm-9 paging_right_10px" style="margin-bottom:10px;">
              ...
              <li>
                ...
                <a href="index.php?com=newsletter&act=man">Đăng ký nhận tin</a>

              </li>
              <li>

                <a href="index.php?com=newsletter_mailthanhvien&act=man">Tạo tài khoản</a>

              </li>
              <!--   <li>

                <a href="index.php?com=thongbaocohang&act=man">Thông báo có hàng</a>
           ...
           <li>
                ...
                <a href="index.php?com=ykien&act=man">Những câu hỏi thường gặp</a>
