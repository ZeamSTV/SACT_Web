          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="inner">
			  ...
			  <div class="col-md-2"><label>Số thứ tự</label></div>
                ...
                <div class="col-md-10"><img src="<?=_upload_sanpham.$item['photo']?>"  width="100px" /><br /><br /></div>
...
<!-- 
                       ...
                       <div class="col-md-2"><label>Chọn màu cho tên</label></div>

                       <div class="col-md-10"><input type="color" style="-webkit-appearance: square-button;
    ...
    border-image: initial;" name="mausac" id="mausac" value="<?=$item['mausac']?>" placeholder="Màu" /></div> -->
  ...
  <div class="col-md-2"><label>Mô tả</label></div>
    <div class="col-md-10"><textarea name="mota_<?= $value ?>" cols="50" rows="6" placeholder="mota"><?=$item['mota_'.$value]?></textarea></div>
