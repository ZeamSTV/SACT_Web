		...
		<!-- Inline Form Start -->
          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=product&act=save_photo<?=$chuoi_noi_curpagephoto?>" enctype="multipart/form-data" class="basic-form inline-form">
                ...
                <div class="col-md-10 col-md-offset-2">                  
                  ...
                  <button type="button" onclick="javascript:window.location='index.php?com=product&act=man_photo<?=$chuoi_noi_curpagephoto?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
