       ...
       <!--          
			...
			<?php
				...
				{	
					...
					$stmt=mysqli_query($d->db,$sql_huyen);
					$str='
			...
			<!-- 	<th style="width:5%;">Bán chạy</th> -->
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="width:5%;"><a href="index.php?com=product&act=man_photo&id_cat=<?=$v['id']?>&type=sanpham"><i class="fa fa-plus"></i> Add</a></td>
    <!--           
						 <td style="width:5%;"><a href="index.php?com=product&act=man_photocauhinh&id_cat=<?=$v['id']?>&type=sanpham"><i class="fa fa-plus"></i> Add cấu hình</a></td>
               -->
