  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=product&act=man_cat3">Danh mục cấp 4</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <!-- Inline Form Start -->      	      
        <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="inner">
            ...
            <div class="title-bar">
              <div class="col-md-8" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">                 
              	<h4><a href="index.php?com=product&act=add_cat3<?=$chuoi_noi_curpage3?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm danh mục cấp 4</a></h4>      
              </div>
              <div class="col-md-4 paging_0px">  
              	<form action="index.php?com=product&act=man_cat3<?=$chuoi_noi_curpage3?>" method="post" class="inline-form">
            ...
            <script language="javascript">
				function select_onchange(){
					...
					if(b!=0)
						...
						window.location ="index.php?com=product&act=man_cat3";	
					return true;
				}
				function select_onchange1(){
					...
					if(c!=0)
						window.location ="index.php?com=product&act=man_cat3&id_cat="+b.value+"&id_cat1="+c.value+"";	
					else
						window.location ="index.php?com=product&act=man_cat3&id_cat="+b.value+"";
					return true;
				}	
          ...
          if(d!=0)
            window.location ="index.php?com=product&act=man_cat3&id_cat="+b.value+"&id_cat1="+c.value+"&id_cat2="+d.value+"  "; 
          else
            window.location ="index.php?com=product&act=man_cat3&id_cat="+b.value+"&id_cat1="+c.value+"  ";
          return true;
        } 
        ...
        function get_main_category2(){
          ...
          return $str;
            ...
            ?></b></p>
                    ...
                    <td><a href="index.php?com=product&act=edit_cat3&id=<?=$v['id']?><?=$chuoi_noi_curpage3?>" style="text-decoration:none;"><?=$v['ten_vi']?></a></td>
                    ...
                    <td style="width:5%;"><a href="index.php?com=product&act=edit_cat3&id=<?=$v['id']?><?=$chuoi_noi_curpage3?>"><img src="media/images/edit.png" border="0" title="Sửa" /></a></td>
                    <td style="width:5%;"><a href="index.php?com=product&act=delete_cat3&id=<?=$v['id']?><?=$chuoi_noi_curpage3?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>
                  </tr>
                  <?php	
						}
					}
			...
			<div class="col-md-12 margin_bottom_10px">
                <div class="col-md-4 paging_0px">                  
                  <a href="index.php?com=product&act=add_cat3<?=$chuoi_noi_curpage3?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm danh mục cấp 4</a>
                  <a href="index.php?com=product&act=man_cat3" class="btn btn-info"><i class="fa fa-share"></i> Thoát</a> 
                </div>
