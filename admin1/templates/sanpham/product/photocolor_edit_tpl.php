	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<!-- Inline Form Start -->
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=product&act=savecolor_photo<?=$chuoi_noi_curpage2?>" enctype="multipart/form-data" class="basic-form inline-form">
              	<?php if ($_REQUEST['act']=='editcolor_photo'){?>
                ...
                <div class="col-md-2"><label>Hình ảnh <?=$i?></label></div>
                <div class="col-md-10">
          ...
          <div class="col-md-10"><input type="text" name="stt" value="<?=isset($item['stt'])?$item['stt']:1?>" placeholder="Số thứ tự" /></div>
                ...
                <div class="col-md-10"><input type="checkbox" name="hienthi" class="icheck-blue" checked="checked" /> <span class="hienthi_text">Hiển thị</span></div>
