  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=donhangnhanh&act=man" title="Đơn hàng nhanh">Đơn hàng nhanh</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
          ...
          <div class="inner">
            ...
            <div class="title-bar">               
              <div class="col-md-8" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">                 
                <h4>Danh sách đơn hàng nhanh</h4>     
              </div>
              <div class="col-md-4 paging_0px">  
                <form action="index.php?com=donhangnhanh&act=man<?=$chuoi_noi_curpage?>" method="post" class="inline-form">
            ...
            <form name="frm" method="post" action="index.php?com=donhangnhanh&act=send" enctype="multipart/form-data">       
          ...
          ?>
                  <tr>
                    <td style="width:5%;"><input type="checkbox" name="chon" id="chon" value="<?=$v['id']?>" class="chon" /></td> 
                     <td><b><?=$v['tenkhachhang']?></b></td>                   
                    <td><b><?=$v['email']?></b></td>
                    <td style="width:5%;"><a href="index.php?com=donhangnhanh&act=delete&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>
                      <td style="width:5%;"><a href="index.php?com=donhangnhanh&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" ><img src="media/images/edit.png" border="0" title="Xem" /></a></td>
                  </tr>
                  <?php 
            }
          }
