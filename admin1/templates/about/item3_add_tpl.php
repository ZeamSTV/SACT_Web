<script type="text/javascript">
  ...
  tinyMCE.init({
    ...
    mode : "exact",
        ...
        elements : "noidung_vi,noidung_en,noidung_cn,noidung_hq,mota_vi",
  ...
  <div class="row breadcrumbs">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=about&act=capnhap3">GIỚI THIỆU</a></li>
 ...
 -->
      ...
      <!-- 
                ...
                <div class="col-md-10">
                  ...
                  <video id="my_video" controls="" autoplay="" muted="" loop="" playsinline=""><source src="<?=_upload_tinnho.$item['photo1']?>" type="video/mp4"><p>To view this video please enable JavaScript, and consider upgrading to a web browser that <a href="http://videojs.com/html5-video-support/" target="_blank">supports HTML5 video</a></p></video>
...
<!-- 
                                <div class="col-md-2"><label>Mô tả  <?=$value?></label></div>

                <div class="col-md-10"><input type="text" name="h3_<?= $value ?>" id="h3_<?= $value ?>" value="<?=$item['h3_'.$value]?>" placeholder="" /></div>
                ...
                -->
                      ...
                      <div class="col-md-2"><label>Mô tả  <?= $config["langs"][$value]?> </label></div>
                        ...
                        <div class="col-md-10"><textarea name="mota_<?= $value ?>" id="mota_<?= $value ?>" rows="5" placeholder="Mô tả"><?=$item['mota_'.$value]?></textarea><br /></div>
