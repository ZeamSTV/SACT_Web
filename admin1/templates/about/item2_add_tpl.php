  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=about&act=capnhap2">Mô tả lý do</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
...
<!-- 
              ...
              <?php if ($_REQUEST['act']=='capnhap3'){?>
                <div class="col-md-2"><label>Hình 1</label></div>
           ...
           <?php
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
                          <div class="col-md-2"><label>Title 1 <?=$value?></label></div>
                <div class="col-md-10"><input type="text" name="h1_<?= $value ?>" id="h1_<?= $value ?>" value="<?=$item['h1_'.$value]?>" placeholder="" /></div>
                   <div class="col-md-2"><label>Title 2 <?=$value?></label></div>
                <div class="col-md-10"><input type="text" name="h2_<?= $value ?>" id="h2_<?= $value ?>" value="<?=$item['h1_'.$value]?>" placeholder="" /></div>

                   <div class="col-md-2"><label>Title 3 <?=$value?></label></div>
