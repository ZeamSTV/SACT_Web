  ...
  <div class="row breadcrumbs">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tinnho&act=man9">Mục thi công</a></li>
...
<!-- 
          ...
          <!--         <th style="width:5%;">Xóa</th> -->
            ...
            <!--   <td><a href="index.php?com=tinnho&act=edit9&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><img src="<?=_upload_tinnho.$v['download']?>" width="150px"/></a></td> -->
