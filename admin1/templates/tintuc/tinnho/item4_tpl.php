...
<!-- Breadcrumbs Start -->
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tinnho&act=man4">Chỉ đường</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="message-box info">
              ...
              <p>Lưu ý: Chỉ để hiển thị 1 tin Chỉ đường!</p>
            </div>
        </div>
          ...
          <div class="inner">
            ...
            <div class="title-bar"> 
              <div class="col-md-8" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">                 
              	<h4><a href="index.php?com=tinnho&act=add4<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm Chỉ đường</a></h4>      
              </div>
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">            
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="index.php?com=tinnho&act=edit4&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><?=$v['ten']?></a></td>
			...
			<div class="col-md-12 margin_bottom_10px">
                <div class="col-md-4 paging_0px">                  
                 <a href="index.php?com=tinnho&act=add4<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm Chỉ đường</a>
