  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tinnho&act=man2">Thông tin cần biết</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <!-- Inline Form Start -->
        ...
        <div class="col-md-2"><label>Số thứ tự</label></div>
                <div class="col-md-10"><input type="text" name="stt" id="stt" value="<?=isset($item['stt'])?$item['stt']:$count+1?>" placeholder="Số thứ tự" /></div>
      <!--   
