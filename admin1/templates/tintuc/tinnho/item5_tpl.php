...
<!-- Breadcrumbs Start -->
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tinnho&act=man5">Ngày giảm giá</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
      ...
      <!-- Inline Form Start -->      	      
        <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="inner">
           ...
           <!--    	<h4><a href="index.php?com=tinnho&act=add5<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm Nền danh mục</a></h4>      
 ...
 -->              </div>
			...
			<div class="col-md-12 margin_bottom_10px">
                <div class="col-md-4 paging_0px">                  
                <!--  <a href="index.php?com=tinnho&act=add5<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm Nền danh mục</a> -->
