...
<!-- Breadcrumbs Start -->
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tinnho&act=man2">APHABET</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="message-box info">
              ...
              <p>Lưu ý: Bên LEFT là các tin ở bên mục Tra hạn bảo hành của thanh LEFT, Nổi Bật là tin sẽ được hiển thị khi click vào Tra hạn bảo hành trên MENU TOP!</p>
            </div>
        </div>-->
      ...
      <!-- Inline Form Start -->      	      
        <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
         ...
         <!--      	<h4> <a href="index.php?com=tinnho&act=add2<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm</a></h4> -->     
              </div>
