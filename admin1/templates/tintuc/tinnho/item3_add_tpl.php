  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tinnho&act=man3">Chính sách</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <?php if ($_REQUEST['act']=='edit3'){?>
                ...
                <div class="col-md-10"><img src="<?=_upload_tinnho.$item['photo']?>"  width="300px" alt="NO PHOTO" /><br /><br /></div>
                <?php }?>
                ...
                <div class="col-md-10"><input type="text" name="ten_vi" id="ten" value="<?=$item['ten_vi']?>" placeholder="Tên 1" /></div>
