  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tinnho&act=man">Coupon</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
           ...
           <!-- PHẦN DƯỚI LÀ DÀNH CHO NỘI DUNG ĐA NGÔN NGỮ-->
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
                       ...
                       <div class="col-md-2"><label>Tên mã <?= $config["langs"][$value]?></label></div>
                       <div class="col-md-10"><input type="text" name="ten_<?= $value ?>" id="ten_<?= $value ?>" value="<?=$item['ten_'.$value]?>" placeholder="Tên mã" />
                         <span class="description">Bạn chỉ cần điền thông tin - mã sẽ tự động tạo sau khi bạn lưu</span>
                         <br /><br />
                       </div>
            
                      <div class="col-md-2"><label>% giảm giá <?= $config["langs"][$value]?> </label></div>
                      <div class="col-md-10"><textarea name="mota_<?=$value?>"  id="mota_<?=$value?>" placeholder="Nhập số"><?=@$item['mota_'.$value]?></textarea><br /></div>
