  ...
  <div class="row breadcrumbs">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tinnho&act=man1">Bài viết</a></li>
...
<!-- 
                           ...
                           <div class="col-md-2"><label>Số liệu thống kê</label></div>

                <div class="col-md-10"><input type="text" name="mapmota" id="mapmota" value="<?=$item['mapmota']?>" placeholder="Số liệu" /></div>
