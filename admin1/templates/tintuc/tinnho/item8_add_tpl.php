  ...
  <div class="row breadcrumbs">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tinnho&act=man8">Mục quy trình thiết kế</a></li>
...
<!--              <?php if ($_REQUEST['act']=='edit8'){?>
 ...
 -->
                    ...
                    <!--  <div class="col-md-2"><label>Link download </label></div>

                       <div class="col-md-10"><input type="text" name="mapmota" id="mapmota" value="<?=$item['mapmota']?>" placeholder="Tên" /></div>
 -->
