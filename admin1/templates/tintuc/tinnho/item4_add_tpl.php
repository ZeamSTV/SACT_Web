          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
			  ...
			  <div class="col-md-2"><label>Số thứ tự</label></div>
                ...
                <div class="col-md-2"><label>Link map </label></div>
                <div class="col-md-10"><textarea name="noidung" id="noidung" placeholder="Link map"><?=$item['noidung']?></textarea><br /></div>
                
				<!---
                <div class="col-md-2"><label>Link map</label></div>
                <div class="col-md-10"><input type="text" name="title" id="title" value="<?=$item['title']?>" placeholder="Link map" /></div>
				--->
				<!---
