...
global $d;
       ...
       -->
           ...
           <div class="col-md-10"><input type="text" name="gia" id="tenchudautu" value="<?=$item['gia']?>" placeholder="Giá" />
             ...
             -->
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
                      ...
                      <div class="col-md-10"><textarea name="noidung_<?= $value ?>" id="noidung_<?= $value ?>" class="editor" placeholder="Nội dung"><?=$item['noidung_'.$value]?></textarea><br /></div>
