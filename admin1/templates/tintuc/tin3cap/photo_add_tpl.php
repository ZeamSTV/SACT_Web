  ...
  <div class="row breadcrumbs">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <ul class="breadcrumbs">
        ...
        $sql="select * from #_tin3cap where id='".intval($_REQUEST['id_cat'])."'";  
      ...
      ?></b>
        ...
        <li><a href="index.php?com=tin3cap&act=man_photo<?=$chuoi_noi_curpage2?>">Hình ảnh</a></li>
    ...
    <!-- Inline Form Start -->
          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=tin3cap&act=save_photo<?=$chuoi_noi_curpage2?>" enctype="multipart/form-data" class="basic-form inline-form">
                ...
                <div class="col-md-10">
                  ...
                  <input type="file" name="file<?=$i?>" /> 
                    ...
                    <span class="description">Type: .jpg|.gif|.png|.jpeg &nbsp;&nbsp;;&nbsp;&nbsp; Ảnh chuẩn: Width:1600px - Height:500px. </span>
                ...
                <div class="col-md-10"><input type="text" name="ten<?=$i?>" placeholder="Tên" /></div>
                ...
                <div class="col-md-10 col-md-offset-2">                  
                  ...
                  <button type="button" onclick="javascript:window.location='index.php?com=tin3cap&act=man_photo<?=$chuoi_noi_curpage2?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
