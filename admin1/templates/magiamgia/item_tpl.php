  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=magiamgia&act=man" title="Email đăng ký">Mã giảm giá</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
          ...
          <div class="inner">
            ...
            <div class="title-bar">               
              <div class="col-md-8" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">                 
                ...
                <a href="index.php?com=magiamgia&act=add<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm mã giảm giá</a> 
       <!--           <a href="index.php?com=magiamgia&act=add<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Kích hoạt mã đã tạo</a> -->

          <!--         <a href="#" class="btn btn-danger" id="xoahet"><i class="fa fa-times"></i> Xóa mã chưa kích hoạt</a>  -->
          
              </div>
         <!--      <div class="col-md-4 paging_0px">  
              	<form action="index.php?com=magiamgia&act=man<?=$chuoi_noi_curpage?>" method="post" class="inline-form">
            ...
            <form name="frm" method="post" action="index.php?com=magiamgia&act=send" enctype="multipart/form-data">		    
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">            
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><b><?=$v['magiamgia']?></b></td>                
                    <td><b><?=date('d/m/Y',$v['ngaytao'])?></b></td>
                     <td><b><?=($v['ngaykichhoat']!='')?date('d/m/Y',$v['ngaykichhoat']):''?></b></td>
                      <td><b><?=($v['ngayhethan']!='')?date('d/m/Y',$v['ngayhethan']):''?></b></td>
                      <td><b><?=number_format($v['giatrimagiamgia'],0, ',', ',')." đ"?></b></td>
                       <td><b><?=number_format($v['giatridonhangtoithieu'],0, ',', ',')." đ"?></b></td>
                        <td><b><?=$v['dasudung']?>/<?=$v['soluot']?></b></td>
                    ...
                    <td style="width:5%;"><a><img style="width: 16px;" src="media/images/check.png" border="0" title="Xóa" /></a></td>
                      <td style="width:5%;"><a ><img style="width: 16px;" src="media/images/check.png" border="0" title="Xem" /></a></td>
                      <?php } else {?>

                         <td style="width:5%;"><a href="index.php?com=magiamgia&act=delete&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>
                      <td style="width:5%;"><a href="index.php?com=magiamgia&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" ><img src="media/images/edit.png" border="0" title="Xem" /></a></td>
