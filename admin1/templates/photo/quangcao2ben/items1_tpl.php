...
<!-- Breadcrumbs Start -->
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=photo&act=man_quangcao2ben1<?=$chuoi_noi_curpage?>">Hình ảnh </a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
 ...
 -->                  <th style="width:5%;">Hiển thị</th>
     ...
     <!--       <td><a href="index.php?com=photo&act=edit_quangcao2ben1&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><?=$v['ten_vi']?></td> -->
