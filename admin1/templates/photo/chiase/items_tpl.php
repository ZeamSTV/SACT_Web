  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=photo&act=man_chiase">Thống kê</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
          ...
          <div class="inner">
            ...
            <div class="table-holder">
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">       
                ...
                <td><a href="index.php?com=photo&act=edit_chiase&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><?=$v['ten_vi']?></td> 
