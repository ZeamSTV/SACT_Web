  ...
  <div class="row breadcrumbs">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=photo&act=capnhap_banner">Cập nhập Banner giữa</a></li>
     ...
     -->
		...
		<!-- Inline Form Start -->
          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=photo&act=save_banner" enctype="multipart/form-data" class="basic-form inline-form">                              
                ...
                <div class="col-md-2"><label>Banner:</label></div>

                <div class="col-md-10">

                	<?php if($item['photo']!=NULL){ ?>            

                    <object width="485px" height="98px"  codebase="http://active.macromedia.com/flash4/cabs/swflash.cab#version=4,0,0,0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">
                      ...
                      <embed src="<?=_upload_hinhanh.$item['photo']?>" quality="High" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" width="485px" height="98px" scale="ExactFit"></embed>
                ...
                <div class="col-md-10">
                    ...
                    <span class="description">Width:1366px -Height:120px</span>
         ...
         <!--        
                ...
                <div class="col-md-2"><label>Banner 1 hiện tại:</label></div>

                <div class="col-md-10">

                  <?php if($item['photo1']!=NULL){ ?>            
                      <div class="col-md-2"><label>Hình hiện tại</label></div>
                       <div class="col-md-10"><img src="<?=_upload_hinhanh.$item['thumb']?>"  width="72" alt="NO PHOTO" /><br /><br /></div>
                ...
                <div class="col-md-2"><label>Banner 1</label></div>

                <div class="col-md-10">

                  <input type="file" name="file1" /> 

                    <span class="description">Width:768px-Height:200px</span>
