...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="index.php?com=hethong&act=man">Bài viết</a></li>
...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=hethong&act=save<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data" class="basic-form inline-form">
                       ...
                       <div class="avatar-upload">
                           ...
                           <?php if ($_REQUEST['act']=='edit'&&$item['photo']!=''){?>
                             <div class="avatar-preview">
                                 <div id="imagePreview" style="background-image: url(<?=_upload_hethong.$item['photo']?>);">
                                 </div>
                             </div>
                           <?php } else{?>
                  ...
                  <!-- hinh dinh kem-->
                   		  ...
                   		  <?php if ($_REQUEST['act']=='edit'&&$item['photo1']!=''){?>
                              <video width="320" height="240" controls>
                                  <source src="<?=_upload_hethong.$item['photo1']?>" type="video/mp4">
                         ...
                         <div class="col-sm-12" style="padding-left: 0">
                            <div class="clearfix">
                                ...
                                <div class="item_trich trich<?=$list_trichdoan[$i]['id']?>">
                                 <img class="img_trich"  src="<?=_upload_hethong.$list_trichdoan[$i]['photo']?>" />
