      ...
      <!-- Inline Form Start -->      	      
        <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="inner">
            ...
            <form name="frm" method="post" action="index.php?com=hethong&act=save_photo&id=<?=$_REQUEST['id'];?><?=($_REQUEST['id_cat']!=0)?"&id_cat=".$_REQUEST['id_cat']:""?><?=($_REQUEST['curPage']!="")?"&curPage=".$_REQUEST['curPage']:""?>" enctype="multipart/form-data" class="nhaplieu">
                ...
                <div class="col-md-10"><img src="<?=_upload_hethong.$item['photo']?>"  width="296" alt="NO PHOTO" /><br /><br /></div>
                <?php }?>
                <div class="col-md-2"><label>Hình ảnh</label></div>
                <div class="col-md-10">
                	<input type="file" name="file" /> 
                    <span class="description">Type: .jpg|.gif|.png|.jpeg &nbsp;&nbsp;;&nbsp;&nbsp; Ảnh chuẩn: 900x654 (theo px)</span>
                    <br /><br />
                </div>
                <div class="clear"></div>
                ...
                <div class="col-md-10 col-md-offset-2">                  
                  ...
                  <button type="button" onclick="javascript:window.location='index.php?com=hethong&act=man<?=$chuoi_noi_curpage?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
                </div>
