...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="index.php?com=about&act=capnhap">Mô tả</a></li>
...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=about&act=save<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data"    class="basic-form inline-form">
            ...
            <div class="box">
               ...
               <div class="tab-content">
                  ...
                  <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
                            ...
                            <div class="form-group">
                              <label>Mô tả 1  <?= $config["langs"][$value]?></label>
                           ...
                           <input type="text" name="h2_<?= $value ?>" class="form-control" value="<?=$item['h2_'.$value]?>" >
                            ...
                            <div class="form-group">
                              <label>Mô tả 2<?= $config["langs"][$value]?><a class="cus_tool" title="Viết nội dung chính"></a></label>
                              <textarea name="noidung_<?= $value ?>" id="noidung_<?= $value ?>" class="form-control " rows="5" cols="50"><?=$item['noidung_'.$value]?></textarea>
                           </div>
                  ...
                  <div class="form-group ">
                     <!-- avatar -->
                       ...
                       <div class="avatar-upload">
                           ...
                           <?php if ($_REQUEST['act']=='capnhap'&&$item['photo']!=''){?>
