...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="index.php?com=about&act=capnhap2">Mô tả</a></li>
...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=about&act=save2<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data"    class="basic-form inline-form">
               ...
               <div class="tab-content">
                  ...
                  <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
                            ...
                            <div class="form-group">
                              <label>Tiêu đề 1 <?= $config["langs"][$value]?><a class="cus_tool" title="Viết nội dung chính"></a></label>
                              
                              <input type="text" name="h1_<?= $value ?>" class="form-control" value="<?=$item['h1_'.$value]?>" >
                           </div>
                            <div class="form-group">
                              <label>Tiêu đề 2 <?= $config["langs"][$value]?><a class="cus_tool" title="Viết nội dung chính"></a></label>
                           <input type="text" name="h2_<?= $value ?>" class="form-control" value="<?=$item['h2_'.$value]?>" >
                           </div>
                             <div class="form-group">
                              <label>Tiêu đề 3 <?= $config["langs"][$value]?><a class="cus_tool" title="Viết nội dung chính"></a></label>
                           <input type="text" name="h3_<?= $value ?>" class="form-control" value="<?=$item['h3_'.$value]?>" >
                           </div>
                             <div class="form-group">
                       ...
                       >
                         ...
                         <!--   <div class="form-group">
                              ...
                              <textarea name="noidung_<?= $value ?>" id="noidung_<?= $value ?>" class="form-control editor" rows="5" cols="50"><?=$item['noidung_'.$value]?></textarea>
                           </div> -->
                  </div>
                  ...
                  <div class="form-group ">
                     <!-- avatar -->
                       ...
                       <div class="avatar-upload">
                           ...
                           <?php if ($_REQUEST['act']=='capnhap2'&&$item['photo']!=''){?>
                     ...
                     <!-- end avartar -->
                     <span class="cus_help">Banner 1. Kích thước 600 x 600</span>
                  </div>
                    ...
                    <div class="form-group ">
                     <!-- avatar -->
                       ...
                       <div class="avatar-upload">
                           ...
                           <?php if ($_REQUEST['act']=='capnhap2'&&$item['photo']!=''){?>
                             <div class="avatar-preview">
                                 <div id="imagePreview1" style="background-image: url(<?=_upload_tinnho.$item['photo1']?>);">
                                 </div>
                             </div>
                           <?php } else{?>
                     ...
                     <!-- end avartar -->
                     <span class="cus_help">Banner 2. Kích thước 1200 x 400</span>
                  </div>
