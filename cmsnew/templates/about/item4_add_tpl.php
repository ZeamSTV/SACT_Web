...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="index.php?com=about&act=capnhap4"></a></li>
...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=about&act=save4<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data"    class="basic-form inline-form">
               ...
               <div class="tab-content">
                  ...
                  <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
                          ...
                          <div class="form-group">
                              <label>Tiêu đề <a class="cus_tool" title="Viết nội dung chính"></a></label>
                           

                              <input type="text" class="form-control" name="h1_<?= $value ?>" value="<?=$item['h1_'.$value]?>">
                           </div>
                   <!--    
                  ...
                  <div class="form-group  ">
                     <!-- avatar -->
                       ...
                       <div class="avatar-upload">
                           ...
                           <?php if ($_REQUEST['act']=='capnhap4'&&$item['photo']!=''){?>
                     ...
                     <!-- end avartar -->
                     <span class="cus_help">Banner trang chủ. Kích thước 300 x 300</span>
                  </div>
