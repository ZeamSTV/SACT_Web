...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="index.php?com=about&act=capnhap3">Mô tả</a></li>
...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=about&act=save3<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data"    class="basic-form inline-form">
                  ...
                  <div class="form-group ">
                     <!-- avatar -->
                       ...
                       <div class="avatar-upload">
                           ...
                           <?php if ($_REQUEST['act']=='capnhap3'&&$item['photo']!=''){?>
                     ...
                     <!-- end avartar -->
                     <span class="cus_help">Banner trang chủ. Kích thước 600 x 600</span>
                  </div>
                   ...
                   <div class="form-group ">
                     <!-- avatar -->
                       ...
                       <div class="avatar-upload">
                             <div class="avatar-edit">
                                 <input type='file' name='file2' id="imageUpload1" accept=".png, .jpg, .jpeg" />
                                 <label for="imageUpload1"></label>
                             </div>

                           <?php if ($_REQUEST['act']=='capnhap3'&&$item['photo2']!=''){?>
                             <div class="avatar-preview">
                                 <div id="imagePreview1" style="background-image: url(<?=_upload_tinnho.$item['photo2']?>);">
                                 </div>
                             </div>
                           <?php } else{?>
