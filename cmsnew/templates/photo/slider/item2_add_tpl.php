...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="index.php?com=photo&act=man2">Photo</a></li>
...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=photo&act=save2<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data" class="basic-form inline-form">
                  ...
                  <div class="form-group">
                     <!-- avatar -->
                       ...
                       <div class="avatar-upload">
                           ...
                           <?php if ($_REQUEST['act']=='edit2'&&$item['photo']!=''){?>
                     ...
                     <!-- end avartar -->
                     <span class="cus_help">Hình đại diện. Kích thước 1366px x 600px</span>
                  </div>
