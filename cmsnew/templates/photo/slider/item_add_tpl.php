...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=photo&act=save<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data" class="basic-form inline-form">
            ...
            <div class="box">
               ...
               <div class="box-body">
                ...
                <div class="form-group hidden">
                     <!-- avatar -->
                       ...
                       <div class="avatar-upload">
                           ...
                           <?php if ($_REQUEST['act']=='edit'&&$item['photo2']!=''){?>
                             <div class="avatar-preview">
                                 <div id="imagePreview1" style="background-image: url(<?=_upload_hinhanh.$item['photo2']?>);">
                                 </div>
                             </div>
                           <?php } else{?>
                     ...
                     <!-- end avartar -->
                     <span class="cus_help">Hình Slide EN. Kích thước 1366px x 740px</span>
                  </div>
