...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="index.php?com=photo&act=man1">Đánh giá</a></li>
...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=photo&act=save1<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data" class="basic-form inline-form">
            ...
            <div class="box">
               ...
               <div class="box-body">
                  <div class="form-group">
                     ...
                     <!-- end avartar -->
                     <span class="cus_help">Hình đại diện. Kích thước 1366 x 500px</span>
                  </div>
