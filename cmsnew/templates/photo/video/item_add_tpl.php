...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=photo&act=save_video<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data" class="basic-form inline-form">
            ...
            <div class="box">
               ...
               <div class="tab-content">
                  ...
                  <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
                    ...
                    <!--        <div class="form-group">
                              <label>Link <?= $config["langs"][$value]?></label>
                  ...
                  <div class="form-group">
                     <!-- avatar -->
                       ...
                       <div class="avatar-upload">
                           ...
                           <?php if ($_REQUEST['act']=='edit_video'&&$item['photo']!=''){?>
