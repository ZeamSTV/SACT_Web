...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="index.php?com=photo&act=man_chiase">Slideshow</a></li>
...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=photo&act=save_chiase<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data" class="basic-form inline-form">
                  ...
                  <div class="form-group">
                     <!-- avatar -->
                       ...
                       <div class="avatar-upload">
                           ...
                           <?php if ($_REQUEST['act']=='edit_chiase'&&$item['photo']!=''){?>
