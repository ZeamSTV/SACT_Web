  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=photo&act=man_quangcao2ben">Quảng cáo TC</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=photo&act=save_quangcao2ben<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">  
                ...
                <div class="col-md-10"><img src="<?=_upload_hinhanh.$item['photo']?>"  style="max-width:60%" alt="NO PHOTO" /><br /><br /></div>
                <?php }?>
                <div class="col-md-2"><label>Hình ảnh</label></div>
                <div class="col-md-10">
                	<input type="file" name="file" /> 
                    <span class="description">Type: .jpg|.gif|.png|.jpeg &nbsp;&nbsp;;&nbsp;&nbsp; Ảnh chuẩn: Width: 1266px - Height: 235px</span>
                    <br /><br />
                </div>
                ...
                <div class="col-md-10"><input type="text" name="link" value="<?=$item['link']?>" placeholder="Link" />
