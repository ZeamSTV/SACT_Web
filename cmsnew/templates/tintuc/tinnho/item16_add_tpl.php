...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="index.php?com=tinnho&act=man16">Kích thước</a></li>
...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=tinnho&act=save16<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data" class="basic-form inline-form">
