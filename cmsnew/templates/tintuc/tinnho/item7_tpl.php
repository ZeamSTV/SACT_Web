...
<section class="content-header">
   ...
   <!--    <a href="index.php?com=tinnho&act=add7<?=$chuoi_noi_curpage1?>" class="btn btn-success btn-flat">
      <i class="fa fa-plus-circle"></i> Thêm mới
      </a> -->
   </h1>
   <ol class="breadcrumb">
      <li><a href="index.php"><i class="fa fa-dashboard"></i>Bảng điều khiển</a></li>
      <li class="active">Chính sách quy định</li>
   </ol>
</section>
  ...
  <!--                    <th class="text-center">Nổi bật</th> -->
          ...
          ?>
                 ...
                 <!--    <td class="text-center">
                     ...
                     <td class="text-center">
                        <a href="index.php?com=tinnho&act=edit7&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>" class="btn btn-sm <!-- btn-social-icon btn-warning" title="Chỉnh sửa"><i class="fa fa-edit fa-fw"></i></a>
                <!--        <a  href="index.php?com=tinnho&act=delete7&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>" onClick="if(!confirm('Xác nhận xóa')) return false;" class="btn btn-sm btn-social-icon btn-danger" title="Xóa"><i class="fa fa-trash-o fa-fw"></i></a> -->
                  </tr>
