...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=tinnho&act=save9<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data" class="basic-form inline-form">
                  ...
                  <div class="form-group ">
                     <!-- avatar -->
                       ...
                       <div class="avatar-upload">
                           ...
                           <?php if ($_REQUEST['act']=='edit9'&&$item['photo']!=''){?>
