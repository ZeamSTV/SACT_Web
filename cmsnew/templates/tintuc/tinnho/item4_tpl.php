  ...
  <!--                    <th class="text-center">Nổi bật</th> -->
          ...
          ?>
                 ...
                 <!--    <td class="text-center">
                     ...
                     <td class="text-center">
                        <a href="index.php?com=tinnho&act=edit4&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>" class="btn btn-sm btn-social-icon btn-warning" title="Chỉnh sửa"><i class="fa fa-edit fa-fw"></i></a>
       <!--                  <a  href="index.php?com=tinnho&act=delete4&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>" onClick="if(!confirm('Xác nhận xóa')) return false;" class="btn btn-sm btn-social-icon btn-danger" title="Xóa"><i class="fa fa-trash-o fa-fw"></i></a> -->
                     </td>
                  </tr>
