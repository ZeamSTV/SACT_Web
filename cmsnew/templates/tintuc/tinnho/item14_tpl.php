...
<section class="content-header">
   <h1>Quản lý <small> Khoảng giá</small>
      <a href="index.php?com=tinnho&act=add14<?=$chuoi_noi_curpage1?>" class="btn btn-success btn-flat">
          ...
          ?>
                  <tr class='row_1'>
                    ...
                    <td>--| <strong><?=$v['ten_vi']?></strong>
                     ...
                     <td class="text-center">
                        <a href="index.php?com=tinnho&act=edit14&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>" class="btn btn-sm btn-social-icon btn-warning" title="Chỉnh sửa"><i class="fa fa-edit fa-fw"></i></a>
                        <a  href="index.php?com=tinnho&act=delete14&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>" onClick="if(!confirm('Xác nhận xóa')) return false;" class="btn btn-sm btn-social-icon btn-danger" title="Xóa"><i class="fa fa-trash-o fa-fw"></i></a>
                     </td>
                  </tr>
