...
<section class="content-header">
   <h1>Quản lý <small></small>
      <a href="index.php?com=tinnho&act=add3<?=$chuoi_noi_curpage1?>" class="btn btn-success btn-flat">
          ...
          ?>
           ...
           <!--           <td><a href="index.php?com=tinnho&act=edit6&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><img src="<?=_upload_tinnho.$v['photo']?>" width="100px"/></a></td> -->
                 ...
                 <!--    <td class="text-center">
                     ...
                     <td class="text-center">
                        <a href="index.php?com=tinnho&act=edit3&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>" class="btn btn-sm btn-social-icon btn-warning" title="Chỉnh sửa"><i class="fa fa-edit fa-fw"></i></a>
                        <a  href="index.php?com=tinnho&act=delete3&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>" onClick="if(!confirm('Xác nhận xóa')) return false;" class="btn btn-sm btn-social-icon btn-danger" title="Xóa"><i class="fa fa-trash-o fa-fw"></i></a>
                     </td>
                  </tr>
