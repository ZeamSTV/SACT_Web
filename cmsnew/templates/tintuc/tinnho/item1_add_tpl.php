...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="index.php?com=tinnho&act=man1">Meta seo</a></li>
...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=tinnho&act=save1<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data" class="basic-form inline-form">
         ...
         <div class="col-md-8">
            <div class="box">
               ...
               <div class="box-body">
                  <div class="form-group  ">
                     <!-- avatar -->
                       ...
                       <div class="avatar-upload">
                           ...
                           <?php if ($_REQUEST['act']=='edit1'&&$item['photo']!=''){?>
                 ...
                 <div class="form-group">
                     <label>Thứ tự</label>
                     <input type="number" name="stt" value="<?=($item['stt']!='')?$item['stt']:0?>"  class="form-control" placeholder="0">
            ...
            <!--       <div class="form-group">
                ...
                <!--          <div class="form-group">
                              <label>SVG <?= $config["langs"][$value]?></label>
                              <textarea name="mota_vi" class="form-control" cols="50" rows="5" id="mota_vi placeholder="Mô tả"><?=@$item['mota_vi']?></textarea>
               ...
               <div class="tab-content">
                  ...
                  <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
                      ...
                      <div class="form-group">
                              <label>Mô tả <?= $config["langs"][$value]?><a class="cus_tool" title="Viết nội dung chính"></a></label>
                              <textarea name="mota_<?= $value ?>" id="mota_<?= $value ?>" class="form-control " rows="10" cols="80"><?=$item['mota_'.$value]?></textarea>
                           </div>
