...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="index.php?com=tinnho&act=man2">Vận chuyển</a></li>
...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=tinnho&act=save2<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data" class="basic-form inline-form">
               ...
               <div class="tab-content">
                  ...
                  <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              <label>Giá ship <?= $config["langs"][$value]?></label>
