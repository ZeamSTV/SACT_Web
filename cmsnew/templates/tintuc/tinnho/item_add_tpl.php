...
<section class="content-header">
   <h1>Giới thiệu sản phẩm
      
   </h1>
   <ol class="breadcrumb">
      <li><a href="index.php"><i class="fa fa-dashboard"></i>Bảng điều khiển</a></li>
      <li><a href="index.php?com=tinnho&act=man">Giới thiệu sản phẩm</a></li>
...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=tinnho&act=save<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data" class="basic-form inline-form">
         ...
         <div class="col-md-8 ">
            <div class="box">
             ...
             <div class="form-group">
                     <label>Link</label>
                     <input type="text" name="tenkhongdau_vi"  value="<?=$item['tenkhongdau_vi']?>" class="form-control">
               ...
               <div class="tab-content ">
                  ...
                  <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="ten_<?= $value ?>"  value="<?=$item['ten_'.$value]?>" class="form-control" id="auto_convert_name">
