...
<section class="content-header">
   <h1>Quản lý <small>nhà sáng lập</small>
    <!--   <a href="index.php?com=tinnho&act=add6<?=$chuoi_noi_curpage1?>" class="btn btn-success btn-flat">
      <i class="fa fa-plus-circle"></i> Thêm mới
      </a> -->
   </h1>
   <ol class="breadcrumb">
      <li><a href="index.php"><i class="fa fa-dashboard"></i>Bảng điều khiển</a></li>
      <li class="active">Nhà sáng lập</li>
   </ol>
</section>
          ...
          ?>
           ...
           <!--           <td><a href="index.php?com=tinnho&act=edit6&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><img src="<?=_upload_tinnho.$v['photo']?>" width="100px"/></a></td> -->
                 ...
                 <!--    <td class="text-center">
                     ...
                     <td class="text-center">
                        <a href="index.php?com=tinnho&act=edit6&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>" class="btn btn-sm btn-social-icon btn-warning" title="Chỉnh sửa"><i class="fa fa-edit fa-fw"></i></a>
                    <!--     <a  href="index.php?com=tinnho&act=delete6&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>" onClick="if(!confirm('Xác nhận xóa')) return false;" class="btn btn-sm btn-social-icon btn-danger" title="Xóa"><i class="fa fa-trash-o fa-fw"></i></a> -->
                     </td>
                  </tr>
