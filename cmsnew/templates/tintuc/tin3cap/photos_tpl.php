                ...
                <tbody>
                  <?php for($i=0, $count=count($items); $i<$count; $i++){?>
                	<tr>
                        ...
                        <td style="width:25%;">		
                		<?php
                		$sql_danhmuc1="select ten from table_tin3cap where id='".$items[$i]['id_cat']."'";
                        ...
                        <img src="<?=_upload_tin3cap.$items[$i]['photo']?>" width="100" height="100" />
                		  ...
                		  <td style="width:5%;"><a class="clickhienthi" thaydoiloai="hienthi"   thaydoitable="table_congtrinh_photo"  thaydoiid="<?=$items[$i]['id']?>" id="idcsshienthi<?=$items[$i]['id']?>" >  <img src="<?=($items[$i]['hienthi']==1)?'media/images/active_1.png':'media/images/active_0.png'?>" border="0" /></a></td>   
