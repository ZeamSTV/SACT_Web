...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="index.php?com=congtrinh&act=man">Bài viết</a></li>
...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=congtrinh&act=save<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data" class="basic-form inline-form">
                       ...
                       <div class="avatar-upload">
                           ...
                           <?php if ($_REQUEST['act']=='edit'&&$item['photo']!=''){?>
                             <div class="avatar-preview">
                                 <div id="imagePreview" style="background-image: url(<?=_upload_congtrinh.$item['photo']?>);">
                                 </div>
                             </div>
                           <?php } else{?>
                         ...
                         <div class="col-sm-12" style="padding-left: 0">
                            <div class="clearfix">
                                ...
                                <div class="item_trich trich<?=$list_trichdoan[$i]['id']?>">
                                 <img class="img_trich"  src="<?=_upload_congtrinh.$list_trichdoan[$i]['photo']?>" />
