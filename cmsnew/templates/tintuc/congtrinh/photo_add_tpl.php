  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li>Sản phẩm : <b><?php
        $sql="select * from #_congtrinh where id='".intval($_REQUEST['id_cat'])."'";  
        $d->query($sql);
        $pro = $d->fetch_array();
        echo $pro['ten_vi'];
      ?></b>
        </li>
        <li><a href="index.php?com=congtrinh&act=man_photo<?=$chuoi_noi_curpage2?>">Hình ảnh</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
    ...
    <!-- Inline Form Start -->
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=congtrinh&act=save_photo<?=$chuoi_noi_curpage2?>" enctype="multipart/form-data" class="basic-form inline-form">
                <?php for($i=0; $i<5; $i++){?>  
                ...
                <div class="col-md-10 col-md-offset-2">                  
                  ...
                  <button type="button" onclick="javascript:window.location='index.php?com=congtrinh&act=man_photo<?=$chuoi_noi_curpage2?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
                </div>
