    ...
    <script language="javascript">
        ...
        { 
          ...
          if(f==0)
            ...
            window.location ="index.php?com=congtrinh&act=man&id_cat="+b.value+"&id_cat1="+c.value+"&id_cat2="+e.value+"&id_cat3="+f.value; 
          return true;
        }
        ...
        { 
          ...
          if(g==0)
            ...
            window.location ="index.php?com=congtrinh&act=man&id_cat="+b.value+"&id_cat1="+c.value+"&id_cat2="+e.value+"&id_cat3="+f.value+"&id_cat4="+g.value; 
          return true;
        }
...
<section class="content-header">
   <h1>Danh mục <small>Bài viết</small>
      <a href="index.php?com=congtrinh&act=add<?=$chuoi_noi_curpage1?>" class="btn btn-success btn-flat">
         ...
         <div class="box">
          ...
          ?>
                  <tr class='row_1'>
                   ...
                   <td>
                       <a href="index.php?com=congtrinh&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>"><img style="width: 100px" src="<?=_upload_congtrinh.$v['photo']?>"></a>
                     </td>
                  ...
                  ?>
                     ...
                     <td class="text-center">
                        <a  class="anhienajax thea" thaydoiloai="hienthi" thaydoitable="table_congtrinh" thaydoiid="<?=$v['id']?>" id="idcsshienthi<?=$v['id']?>">
                            <?=($v['hienthi']==1)?'<i class="fa fa-check-circle-o"></i> ':'<i class="fa fa-times-circle-o"></i>'?>                     

                         </a>
                     </td>
                     <td class="text-center">
                        <a href="index.php?com=congtrinh&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>" class="btn btn-sm btn-social-icon btn-warning" title="Chỉnh sửa"><i class="fa fa-edit fa-fw"></i></a>
                        <a  href="index.php?com=congtrinh&act=delete&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>" onClick="if(!confirm('Xác nhận xóa')) return false;" class="btn btn-sm btn-social-icon btn-danger" title="Xóa"><i class="fa fa-trash-o fa-fw"></i></a>
                     </td>
                  </tr>
