  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=com1&act=man"> Bảng com</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
    ...
    <!-- Inline Form Start -->
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=com1&act=save" enctype="multipart/form-data" >              
                ...
                <div class="col-md-2"><label>Tên com </label></div>
                <div class="col-md-10"><input type="text" name="ten_com" id="ten_com" value="<?=$item['ten_com']?>" placeholder="Tên com..." /></div>
              <!-- <div class="col-md-2"><label>act </label></div>
                <div class="col-md-10"><input type="text" name="act1" id="act1" value="<?=$item['act']?>" placeholder="act" /></div>
            -->
                 <div class="col-md-2"><label>com </label></div>
                <div class="col-md-10"><input type="text" name="com1" id="com1" value="<?=$item['com']?>" placeholder="act" /></div>
           
                <div class="col-md-2"></div>
               <div class="col-md-10"><input type="checkbox" name="danhmuc" class="icheck-blue" <?=(!isset($item['danhmuc']) || $item['danhmuc']==1)?'checked="checked"':''?> /> <span class="hienthi_text">Danh mục</span></div>
        ...
        <input type="hidden" name="id" id="id" value="<?=@$item['id']?>" />
                ...
                <div class="col-md-10 col-md-offset-2">                  
                  ...
                  <button type="button" onclick="javascript:window.location='index.php?com=com1&act=man<?=$chuoi_noi_curpage?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
                </div>
