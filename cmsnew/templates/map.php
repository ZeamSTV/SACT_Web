        ...
        <script>
            ...
            function initMap() {
                ...
                text = "<b style='color:#000;' " +
                    "style='text-align:center; color:#f00'><span style='color:#449C44'><?php echo $company1['ten_vi'];?></span><br />" +
                    "<?php echo 'Địa chỉ';?>: <span style='color:#333; font-weight:100'><?php echo $company1['diachi_vi'];?></span><br />" +
                     
                    "<?php echo 'Điện thoại';?>: <span style='color:#333; font-weight:100'><?php echo $company1['dienthoai'];?></span><br />" +
