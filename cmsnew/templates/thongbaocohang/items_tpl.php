  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=thongbaocohang&act=man" title="Email đăng ký">Thông báo khi có hàng</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
          ...
          <div class="inner">
            ...
            <div class="title-bar">               
              ...
              <div class="col-md-4 paging_0px">  
              	<form action="index.php?com=thongbaocohang&act=man<?=$chuoi_noi_curpage?>" method="post" class="inline-form">
            ...
            <form name="frm" method="post" action="index.php?com=thongbaocohang&act=send" enctype="multipart/form-data">		    
            ...
            <div class="table-holder">
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">            
                ...
                <tbody>
				  ...
				  ?>
                  <tr>
                    <td style="width:5%;"><input type="checkbox" name="chon" id="chon" value="<?=$v['id']?>" class="chon" /></td>  <td><b><?=$v['hoten']?></b></td>                  
                    <td><b><?=$v['email']?></b></td>
                    <td><b><?=$v['noidung']?></b></td>
                    <td style="width:5%;"><a href="index.php?com=thongbaocohang&act=delete&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>
                  </tr>
                  <?php	
						}
					}
			...
			<div class="col-md-12 margin_bottom_10px">
                <div class="col-md-4 paging_0px">                  
                  <a href="index.php?com=thongbaocohang&act=add<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-plus"></i> Thêm email</a>                  
                </div>
            ...
            <div class="col-md-12 margin_bottom_10px" style="margin-top:20px;">            	
                ...
                <div class="col-md-10 col-md-offset-2">                  
                  ...
                  <a href="index.php?com=thongbaocohang&act=man" class="btn btn-info"><i class="fa fa-share"></i> Thoát</a> 
                </div>
                <div class="clearfix"></div>
