  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li>Album : <b><?php
				$sql="select ten from #_images_cat where id='".intval($_REQUEST['id_cat'])."'";	
				$d->query($sql);
				$pro = $d->fetch_array();
				echo $pro['ten'];
			?></b>
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">         
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="index.php?com=images&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>"><img src="<?=_upload_images.$v['photo']?>"  style="max-width:200px;" border="0" /></a></td>
                    <td><a href="index.php?com=images&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>"><?=$v['ten']?></a></td>                    
                    <td style="width:5%;"><a class="clickhienthi" thaydoiloai="hienthi"   thaydoitable="table_images" thaydoiid="<?=$v['id']?>" id="idcsshienthi<?=$v['id']?>"><img src="<?=($v['hienthi']==1)?'media/images/active_1.png':'media/images/active_0.png'?>" border="0" /></a></td>
