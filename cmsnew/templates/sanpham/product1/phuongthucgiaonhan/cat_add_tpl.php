...
<section class="content-header">
   <h1>Phương thức vận chuyển
   </h1>
   <ol class="breadcrumb">
      <li><a href="index.php"><i class="fa fa-dashboard"></i>Bảng điều khiển</a></li>
      <li><a href="index.php?com=product1&act=man_ptgiaonhan">Vận chuyển</a></li>
...
<section class="content">
    ...
    <form method="post" name="frm" action="index.php?com=product1&act=save_ptgiaonhan<?=$chuoi_noi_curpage1?>" enctype="multipart/form-data" class="basic-form inline-form">
            ...
            <div class="box">
               ...
               <div class="box-body">
                  <div class="form-group hidden ">
                     ...
                     <!-- end avartar -->
                     <span class="cus_help">Hình đại diện. Kích thước 1000 x 1000px</span>
                  </div>
