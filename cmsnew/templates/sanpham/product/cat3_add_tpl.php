...
<!-- Breadcrumbs Start -->
  ...
  <!-- Breadcrumbs End -->
   ...
   //      });
              ...
              <form method="post" name="frm" action="index.php?com=product&act=save_cat3<?=$chuoi_noi_curpage3?>" enctype="multipart/form-data" class="basic-form inline-form">
			  <div class="col-md-2"><label>Số thứ tự</label></div>
                ...
                <div class="col-md-10 col-md-offset-2">                  
                  ...
                  <button type="button" onclick="javascript:window.location='index.php?com=product&act=man_cat3<?=$chuoi_noi_curpage3?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
                </div>
