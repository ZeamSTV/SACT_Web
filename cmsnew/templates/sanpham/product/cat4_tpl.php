  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <!-- Inline Form Start -->      	      
        <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="inner">
            ...
            <div class="title-bar">
              <div class="col-md-8" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">                 
              	<h4><a href="index.php?com=product&act=add_cat4<?=$chuoi_noi_curpage3?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm danh mục cấp 5</a></h4>      
              </div>
              <div class="col-md-4 paging_0px">  
              	<form action="index.php?com=product&act=man_cat4<?=$chuoi_noi_curpage3?>" method="post" class="inline-form">
            ...
            <script language="javascript">
				function select_onchange(){
					...
					if(b!=0)
						window.location ="index.php?com=product&act=man_cat4&id_cat="+b.value+"";	
					else
						window.location ="index.php?com=product&act=man_cat4";	
					return true;
				}
				function select_onchange1(){
					...
					if(c!=0)
						window.location ="index.php?com=product&act=man_cat4&id_cat="+b.value+"&id_cat1="+c.value+"";	
					else
						window.location ="index.php?com=product&act=man_cat4&id_cat="+b.value+"";
					return true;
				}	
          ...
          var b=document.getElementById("id_cat");
          var c=document.getElementById("id_cat1");
            var d=document.getElementById("id_cat2");
          if(d!=0)
            window.location ="index.php?com=product&act=man_cat4&id_cat="+b.value+"&id_cat1="+c.value+"&id_cat2="+d.value+"  "; 
          else
            window.location ="index.php?com=product&act=man_cat4&id_cat="+b.value+"&id_cat1="+c.value+"  ";
          return true;
        } 
         function select_onchange3(){
          ...
          var c=document.getElementById("id_cat1");
            var d=document.getElementById("id_cat2");
             var e=document.getElementById("id_cat3");
          if(e!=0)
            window.location ="index.php?com=product&act=man_cat4&id_cat="+b.value+"&id_cat1="+c.value+"&id_cat2="+d.value+"&id_cat3="+e.value+"  "; 
          else
            window.location ="index.php?com=product&act=man_cat4&id_cat="+b.value+"&id_cat1="+c.value+"&id_cat2="+d.value+"  ";
          return true;
        } 
        ...
        function get_main_category2(){
          $sql="select * from table_product_cat where com='cat2' and  id_cat='".(int)@$_REQUEST["id_cat"]."' and id_cat1='".(int)@$_REQUEST["id_cat1"]."'order by stt asc,id desc";
          $stmt=mysql_query($sql);
          $str='
            ...
            ';
          while ($row=@mysql_fetch_array($stmt)){
            if($row["id"]==(int)@$_REQUEST["id_cat2"])
              $selected="selected";
            else 
              $selected="";
            $str.='<option value='.$row["id"].' '.$selected.'>'.$row["ten_vi"].'</option>';     
         ...
         function get_main_category3(){
          $sql="select * from table_product_cat where com='cat3' and  id_cat='".(int)@$_REQUEST["id_cat"]."' and id_cat1='".(int)@$_REQUEST["id_cat1"]."' and id_cat2='".(int)@$_REQUEST["id_cat2"]." 'order by stt asc,id desc";
          $stmt=mysql_query($sql);
          $str='
            ...
            ';
          while ($row=@mysql_fetch_array($stmt)){
            if($row["id"]==(int)@$_REQUEST["id_cat3"])
              $selected="selected";
            else 
              $selected="";
            $str.='<option value='.$row["id"].' '.$selected.'>'.$row["ten_vi"].'</option>';     
          ...
          return $str;
            ...
            <div class="table-holder">
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">  
                <thead>
                  ...
                  <th style="width:15%;">Danh mục cấp 4</th>       
                  <th>Tên</th>
            ...
            ?></b></p>
                    ...
                    <td><a href="index.php?com=product&act=edit_cat4&id=<?=$v['id']?><?=$chuoi_noi_curpage3?>" style="text-decoration:none;"><?=$v['ten_vi']?></a></td>
                    ...
                    <td style="width:5%;"><a href="index.php?com=product&act=edit_cat4&id=<?=$v['id']?><?=$chuoi_noi_curpage3?>"><img src="media/images/edit.png" border="0" title="Sửa" /></a></td>
                    <td style="width:5%;"><a href="index.php?com=product&act=delete_cat4&id=<?=$v['id']?><?=$chuoi_noi_curpage3?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>
                  </tr>
                  <?php	
						}
					}
			...
			<div class="col-md-12 margin_bottom_10px">
                <div class="col-md-4 paging_0px">                  
                  <a href="index.php?com=product&act=add_cat4<?=$chuoi_noi_curpage3?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm danh mục cấp 5</a>
                  <a href="index.php?com=product&act=man_cat4" class="btn btn-info"><i class="fa fa-share"></i> Thoát</a> 
                </div>
