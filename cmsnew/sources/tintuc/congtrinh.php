...
function get(){
	...
	transfer("Không nhận được dữ liệu", "index.php?com=congtrinh&act=man".$chuoi_noi_curpage);
		...
		$sql1 = "select * from #_congtrinh_photo where id_cat='".$id."' order by id asc";
	$d->query($sql1);
                                             ...
                                             $arr_file_del = explode(',',$arr_chuoi);
                                                         ...
                                                         for($i=0;$i<count($_FILES['files']['name']);$i++){
                                                            ...
                                                            {  
                                                                  ...
                                                                  $photo = upload_photos($file, 'jpg|png|gif|PNG|GIF|JPG|JPEG|jpeg', _upload_congtrinh,$file_name);
                                                                  $data1['photo'] = $photo;
