...
$d->reset();
	...
	$cat_main = $d->result_array();		
			...
			$d->reset();
			$sql_tintuc = "select ten_$lang,tenkhongdau_$lang from #_tinnho where hienthi=1 and com=11 order by stt asc, id desc";
			$d->query($sql_tintuc);
...
if($com=='san-pham'){
	...
	$title_bar = $metaseo[0]['title_'.$lang];
	$description = $metaseo[0]['description_'.$lang];
	$keywords = $metaseo[0]['keywords_'.$lang];
	
	$image =_upload_tinnho_l . $metaseo[0]['photo'];


}
if($com=='hop-tac-kinh-doanh'){

	$title_bar = $metaseo[1]['title_'.$lang];
	$description = $metaseo[1]['description_'.$lang];
	$keywords = $metaseo[1]['keywords_'.$lang];
	
	$image =_upload_tinnho_l . $metaseo[1]['photo'];
...
if($com=='tin-tuc'){
	...
	$title_bar = $metaseo[2]['title_'.$lang];
	$description = $metaseo[2]['description_'.$lang];
	$keywords = $metaseo[2]['keywords_'.$lang];
	
	$image =_upload_tinnho_l . $metaseo[2]['photo'];


}
if($com=='tuyen-dung'){

	$title_bar = $metaseo[3]['title_'.$lang];
	$description = $metaseo[3]['description_'.$lang];
	$keywords = $metaseo[3]['keywords_'.$lang];
	
	$image =_upload_tinnho_l . $metaseo[3]['photo'];
...
if($com=='lien-he'){
	...
	$title_bar = $metaseo[4]['title_'.$lang];
	$description = $metaseo[4]['description_'.$lang];
	$keywords = $metaseo[4]['keywords_'.$lang];
	
	$image =_upload_tinnho_l . $metaseo[4]['photo'];
